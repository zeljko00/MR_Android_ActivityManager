...
public class ActivitiesViewModel extends ViewModel {
    ...
    private MutableLiveData<List<ActivityDTO>> sharedData = new MutableLiveData<>();
    private NewActivityListener newActivityListener;

    public void setSharedData(List<ActivityDTO> data) {
        sharedData.setValue(data);
    }

    public LiveData<List<ActivityDTO>> getSharedData() {
        return sharedData;
    }
